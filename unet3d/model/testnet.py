...
def testnet_model(input_shape=(4, 128, 128, 128), optimizer=Adam, initial_learning_rate=5e-4, activation_name="sigmoid",
                  **kwargs):
    ...
    model.compile(optimizer=SGD(lr=initial_learning_rate, momentum=0.9), loss='binary_crossentropy',
                  metrics=['accuracy'])
