...
def siam3dunet_backbone(inputs, n_base_filters=16, depth=5, dropout_rate=0.3,
                        ...
                        activation_name="sigmoid", mask_name='mask1'):
    """
...
def siam3dunet_model(input_shape=(4, 128, 128, 128), optimizer=Adam, initial_learning_rate=5e-4,
                     activation_name="sigmoid", **kwargs):
    ...
    model.compile(optimizer=SGD(lr=initial_learning_rate, momentum=0.9),
                  loss={'score': 'binary_crossentropy', 'mask1': loss_func, 'mask2': loss_func},
                  loss_weights={'score': 1., 'mask1': 0.2, 'mask2': 0.2}, metrics=['accuracy'])
