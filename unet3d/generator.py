...
def get_training_and_validation_generators(data_file0, data_file1, batch_size, n_labels, training_keys_file,
...
def get_validation_split(data_file, training_file, validation_file, data_split=0.8, overwrite=False):
    ...
    if overwrite or not os.path.exists(training_file):
        ...
        training_list = train_listA1 + train_listA2 + train_listB1 + train_listB2 + [
            train_listB2[-1]] + train_listC1 * 5 + train_listC2 * 5
...
def data_generator(data_file0, data_file1, index_list, batch_size=1, n_labels=1, labels=None, augment=False,
                   augment_flip=True,
...
def add_data(x_list, y_list, data_file0, data_file1, index, augment=False, augment_flip=False,
    ...
    if augment:
        ...
        data0, truth0, data1, truth1 = augment_data(data0, data1, truth0, truth1, affine0, affine1, flip=augment_flip,
